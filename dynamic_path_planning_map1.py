...
obstacles = []
obstacles.append(Polygon([(-5.6,-2.4),(5.6,-2.4),(0.6,-5.6),(-5.6,-5.6)]))
...
# Function calls. Please run only one of them at a time. When running one, comment out the other two calls
runDynamicObstacles()
# the below functions are just for debugging
# runReconnect()
# runRegrow()